...
namespace DB {
	...
	Define_Table_Constructor(Storage)
		...
		Define_Table_Create_Function_Filter_String(storagehostlist)
		Define_Table_Create_Function_Filter_String(name)
		Define_Table_Create_Function_Filter_Number(size)
		Define_Table_Create_Function_Filter_String(md5)
		...
		Define_Table_Update_Function_Filter_String(storagehostlist)
		Define_Table_Update_Function_Filter_String(name)
		Define_Table_Update_Function_Filter_Number(size)
		Define_Table_Update_Function_Filter_String(md5)
