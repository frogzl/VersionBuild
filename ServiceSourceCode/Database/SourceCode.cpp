...
namespace DB {
	Define_Table_Constructor(SourceCode)
		...
		Define_Table_Create_Function_Filter_String(version_control_ins_id)
		Define_Table_Create_Function_Filter_String(source_code_folder)
		...
		Define_Table_Update_Function_Filter_String(version_control_ins_id)
		Define_Table_Update_Function_Filter_String(source_code_folder)
