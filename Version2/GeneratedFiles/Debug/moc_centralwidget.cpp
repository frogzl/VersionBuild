...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CentralWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 55, 6)
    ...
    "CentralWidget\0SignalClose\0\0SlotClose\0"
    "SlotTabBarClicked\0nIndex"
};
...
void CentralWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SlotTabBarClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CentralWidget::SignalClose)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CentralWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_CentralWidget.data,
      qt_meta_data_CentralWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CentralWidget.stringdata))
...
// SIGNAL 0
void CentralWidget::SignalClose()
{
