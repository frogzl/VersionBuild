...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainTitleBar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 26, 9)
    ...
    "MainTitleBar\0SignalClose\0\0SlotClose"
};
...
void MainTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MainTitleBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainTitleBar::SignalClose)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MainTitleBar::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MainTitleBar.data,
      qt_meta_data_MainTitleBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainTitleBar.stringdata))
