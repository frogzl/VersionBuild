// SlaveTaskService.cpp : 定义 DLL 应用程序的导出函数。
//

#include "stdafx.h"
#include "MicroServicePlugin.h"
#include "SlaveTaskService.h"
...
ServiceInterface* produce_one()
{
	...
	pService->register_http_route("/task/master/work/start", Http_Operator_Post, RouteCallBackSet::sourcecode_query);
