...
typedef Business* (*FuncCreate)();
#define BUSINESS_OBJECT(class_name)	  public: static Business* create_instance() { return new class_name(); }
#define BUSINESS(class_name)	 #class_name, class_name::create_instance
