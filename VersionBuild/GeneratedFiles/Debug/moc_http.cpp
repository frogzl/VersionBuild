...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Http_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 97, 5)
    ...
    "Http\0SignalGetArray\0\0SignalGetDownFile\0"
    "fileName\0fileBoby\0signalQuit\0replyFinished\0"
...
void Http::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->SignalGetArray((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->SignalGetDownFile((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        case 2: _t->signalQuit(); break;
        ...
        {
            typedef void (Http::*_t)(QByteArray , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Http::SignalGetArray)) {
                *result = 0;
            }
        }
        {
            typedef void (Http::*_t)(QString , QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Http::SignalGetDownFile)) {
                *result = 1;
            }
        }
        {
            typedef void (Http::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Http::signalQuit)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Http::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Http.data,
      qt_meta_data_Http,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Http.stringdata))
...
// SIGNAL 0
void Http::SignalGetArray(QByteArray _t1, int _t2)
{
...
// SIGNAL 1
void Http::SignalGetDownFile(QString _t1, QByteArray _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
