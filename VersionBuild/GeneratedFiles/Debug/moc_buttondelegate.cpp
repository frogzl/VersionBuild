...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ButtonDelegate_t, stringdata) + ofs \
...
const QMetaObject ButtonDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_ButtonDelegate.data,
      qt_meta_data_ButtonDelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ButtonDelegate.stringdata))
