...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProductsTab_t, stringdata) + ofs \
...
const QMetaObject ProductsTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProductsTab.data,
      qt_meta_data_ProductsTab,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProductsTab.stringdata))
